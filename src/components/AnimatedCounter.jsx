            ...
            {counterItems.map((item, index) => (
                <div key={index} className='bg-zinc-900 rounded-lg p-6 flex flex-col justify-center about-box'>
                    <div className='text-white-50 text-lg leading-relaxed'>
                        I'm a final-year Computer Science Engineering student with a strong foundation in <span className="text-white font-bold italic">full-stack web development</span> and <span className="text-white font-bold italic">problem-solving</span>. I've built several academic and personal projects using technologies like <span className="text-white font-bold italic">React</span>, <span className="text-white font-bold italic">Node.js</span>, <span className="text-white font-bold italic">Express</span>, and <span className="text-white font-bold italic">MongoDB</span>. With <span className="text-white font-bold italic">175+ DSA problems</span> solved and active participation in <span className="text-white font-bold italic">hackathons</span>, I bring both technical skills and collaborative experience to the table. I'm passionate about learning, building scalable solutions, and continuously improving as a developer.
                    </div>
                </div>
            ))}
        </div>
